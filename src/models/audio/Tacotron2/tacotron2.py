...
class Encoder(nn.Module):
    def __init__(
        self, num_convs, conv_embed_dim, conv_kernel_size, lstm_embed_dim, pdropout=0.5
    ):
...
class Decoder(nn.Module):
    def __init__(
        ...
        self.attention_lstm = nn.LSTM(
            prenet_dim + encoder_embedding_dim, attention_rnn_dim, 1
        )
...
class Tacotron2(nn.Module):
    ...
    def __init__(
        ...
        self.Encoder = Encoder(
            num_convs=encoder_n_convolutions,
        ...
        self.PostNet = PostNet(
            num_layers=postnet_n_convolutions,
